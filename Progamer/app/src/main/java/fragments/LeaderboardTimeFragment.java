...
public class LeaderboardTimeFragment extends Fragment implements LeaderboardAdapter.clickListener {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        assignSingletons();
        loadData();
        ((LeaderboardFragment) getParentFragment()).syncLeaderboardData("time");
    }
    ...
    private void loadData() {
        ...
        if (leaderboardAdapter.getItemCount() > 1) {
            ...
            overallTopScoreTextView.setText(String.valueOf(currentUser.getUser_overall_time()));
            overallBottomNameTextView.setText(currentUser.getUser_nickname());
            overallBottomScoreTextView.setText(String.valueOf(currentUser.getUser_overall_time()));
            if (currentUserPos <= 2) {
    ...
    public void addList(ArrayList<User> list) {
        if (!list.isEmpty()) {
            ...
            leaderboardAdapter.setUserList(userList, "time");
